...
mkdir -p obj
arm-anykav200-linux-uclibcgnueabi-gcc -fno-strict-aliasing -Os -w -D_GNU_SOURCE -std=c99 -fms-extensions ./ -I/../lib/libplat/include -I -I -c -o obj/convert.o src/convert.c
arm-anykav200-linux-uclibcgnueabi-gcc -fno-strict-aliasing -Os -w -D_GNU_SOURCE -std=c99 -fms-extensions ./ -I/../lib/libplat/include -I -I -c -o obj/main.o src/main.c

arm-anykav200-linux-uclibcgnueabi-gcc.br_real: warning: /home/ubuntu/Desktop/anyka_v380ipcam_experiments/apps/ak_snapshot: linker input file unused because linking not done
